<header id="header">
    <div
        data-uk-sticky="animation: uk-animation-slide-top; sel-target: .uk-navbar-container; cls-active: uk-navbar-sticky; cls-inactive: uk-navbar-transparent ; top: #header">
                ...
                <div class="uk-position-z-index" data-uk-navbar>
                    ...
                    <div class="uk-navbar-right">
                        <ul class="uk-navbar-nav uk-visible@m"
                            ...
                            <li class="{{ Route::currentRouteName() == 'laravue' ? 'uk-active' : '' }}"><a
                                    href="{{ route('laravue') }}">Home</a></li>
                            <li class="{{ Route::currentRouteName() == 'courses' ? 'uk-active' : '' }}"><a
                                    href="">Courses</a></li>
                        </ul>
                        <div>
                        ...
                        <div class="uk-navbar-item">
                            @auth
                                <div class="dropdown">
                                    <button class="uk-button uk-button-primary-light dropdown-toggle" type="button"
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuReference">
                                        ...
                                        <a class="dropdown-item" href="javascript:void(0)"
                                            onclick="event.preventDefault(); document.getElementById('sessionDestroy').submit();">
                                            Logout
                                        </a>
                                        <form action="{{ route('session.logout') }}" method="post" id="sessionDestroy">
                                            @csrf
                                            @method('delete')</form>
                                    </div>
                                </div>
                            ...
                            @guest
                                <div>
                                    <a class="uk-button uk-button-primary-light" href="javascript:void(0)"
                    ...
                    <li>
                        ...
                        <div class="uk-position-cover uk-overlay-light uk-flex uk-flex-middle uk-padding-slide">
                            <div class="uk-width-3-4@m">
                                <h2 class="uk-heading-medium uk-letter-spacing-medium">Start a New Career Begin Today
                                </h2>
                                <p>
                                    <a class="hvr-forward" href="course.html" data-uk-icon="icon: arrow-right">UX Design
                                        with Josh Alkin</a>
                                </p>
                            </div>
                        </div>
                    ...
                    <li>
                        ...
                        <div class="uk-position-cover uk-overlay-xlight uk-flex uk-flex-middle uk-padding-slide">
                            <div class="uk-width-1-2@m">
                                ...
                                <p>
                                    <a class="hvr-forward" href="course.html" data-uk-icon="icon: arrow-right">Outdoor
                                        Photography with Josh Alkin</a>
                                </p>
                            </div>
                        </div>
                    </li>
